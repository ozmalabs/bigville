...
1. terrain tile (`16x16`, scenario grid)
2. small world prop or animal (`16x16` or an integer multiple)
...
silhouette density, roof/interior contrast, and held-item readability. The
runtime assets remain the deterministic atlas generated by
